...
| ---------------------------------------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pre-commit.yaml` (Pre-Commit Checks)    | every push and PR                                                      | `uv sync --all-groups` then `uv run pre-commit run --all-files`: ruff, mdformat, file hygiene, test naming, debug statements, and the full test suite with the 95% gate. `TEST_*` secrets exist only for runs in the base repo (pushes to `dev`), not fork PRs | `uv run pre-commit run --all-files`                                                                                                                                         |
